...
const MapComponent = () => {
  ...
  return (
    <MapContainer>
      ...
      {/* Vulnerability Index Gradient Legend */}
      ...
      <LayerToggle
        ...
        showVulnerabilityAnimation={showVulnerabilityAnimation}
        setShowVulnerabilityAnimation={setShowVulnerabilityAnimation}
      />
      ...
      {/* 311 Calls Color Legend */}
      {(showJune311Calls || showJuly311Calls || showAugust311Calls) && (
        <div style={{
          position: 'fixed',
          left: 24,
          bottom: 380,
      ...
      <VulnerabilityAnimation
        map={map.current}
        isVisible={showVulnerabilityAnimation}
        onAnimationUpdate={(month) => setCurrentAnimationMonth(month)}
      />
    </MapContainer>
  );
};
